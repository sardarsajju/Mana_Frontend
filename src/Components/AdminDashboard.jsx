  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.cardBox}>
        ...
        {/* 🆕 Team Portal Access - ALWAYS ACTIVE */}
        <div
          className={`${styles.card} ${styles.activeCard}`}
          onClick={() => navigate("/admin/team-portal")}
        >
          <div className={styles.cardIcon}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className={styles.cardContent}>
            <h3>Tester / Developer Portal</h3>
            <p>Manage team member accounts and access</p>
          </div>
          {isEmployee && <div className={styles.activeBadge}>✓ Active</div>}
        </div>
      </div>
    </div>
  );
